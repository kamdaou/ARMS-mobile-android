...
import com.amalitech.ui.components.ScreenPlaceHolder
...
fun HomeScreen(
    ...
    navigateToCelebration: () -> Unit,
    navigateToLeaves: () -> Unit
) {
        ...
        HorizontalPager(
            ...
            if (it == 0)
                HomeScreenContent(
                    ...
                    expandCelebrations = navigateToCelebration,
                    expandWhoIsOut = navigateToLeaves
                )
            else
                ScreenPlaceHolder()
        }
